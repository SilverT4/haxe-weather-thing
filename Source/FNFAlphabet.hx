...
/**
 * Copied from Friday Night Funkin'. Loosley based on FlxTypeText lolol
 */
class FNFAlphabet extends FlxSpriteGroup
{
	...
	override function update(elapsed:Float)
	{
		if (isMenuItem)
		{
			...
			var lerpVal:Float = PogTools.boundTo(elapsed * 9.6, 0, 1);
...
class AlphaCharacter extends FlxSprite
{
	...
	{
		super(x, y);
		var tex = PathFinder.birdAtlas('alphabet');
		frames = tex;
